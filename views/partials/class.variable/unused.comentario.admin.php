<div class="d-flex bd-highlight align-items-center">
    ...
    <div class="ml-auto p-1 bd-highlight">
        <button class="btn-block" onclick="LockComent()"></button>
    </div>
</div>
<div class="comment mb-3">
    <p class="info">12:00 pm. 08/Ago/2024</p>
    <p>tiene muy buen contenido, es cortito y directo al grano, para enteder los conceptos fundamentales.</p>
</div>